...
public class InfoDisplay {
    /**
     * Main Application for Information Display Microservice.
     *
    ...
    public static void main(String[] args) throws IOException {
        ...
        try (InputStreamReader inputStreamReader = new InputStreamReader(System.in);
            ...
            SpringApplication.run(InfoDisplay.class, args);
            startMongoDB(userInput);
        }
    }

    /**
     * Starts up Mongo Server.
     *
    ...
    public static void startMongoDB(String userInput) {
        ...
        try {
            ...
            if (userInput.equalsIgnoreCase("yes")) {
                ...
                scriptPath += Paths
                        .get(System.getProperty("user.dir"), "info-display-microservice", "data", "server_scripts",
                                "set-up-servers.sh")
                        .toString();
