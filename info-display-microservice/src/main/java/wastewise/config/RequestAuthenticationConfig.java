...
import wastewise.authentication.JwtAuthenticationEntryPoint;
import wastewise.authentication.JwtRequestFilter;
...
public class RequestAuthenticationConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.csrf().disable()
                .authorizeRequests()
                .antMatchers("/get_country_info(*)").permitAll().anyRequest().authenticated()
                .and()
