package wastewise.listing.profiles;
...
import wastewise.listing.authentication.JwtTokenVerifier;
 ...
 * When this profile is active spring dependency injection will use this class
 * to look for bean methods.
 ...
 * With the tag applied the profile will be inactive by default unless
 * activated.
 * When the profile is active its bean will be used when looking for Beans to
 * auto-inject.
 */
