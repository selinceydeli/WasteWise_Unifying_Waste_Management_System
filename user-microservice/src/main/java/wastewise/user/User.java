    ...
    public static void startMongoDB(String userInput) {
        ...
        try {
            ...
            if (userInput.equalsIgnoreCase("yes")) {
                ...
                scriptPath += Paths.get(System.getProperty("user.dir"), "user-microservice", "data", "server_scripts",
                        "set-up-user-servers.sh").toString();
                System.out.println("path is: " + scriptPath);
            } else {
                // Get the script path for setting up servers
                scriptPath += Paths.get(System.getProperty("user.dir"), "user-microservice", "data", "server_scripts",
                        "start-user-servers.sh").toString();
                System.out.println("path is: " + scriptPath);
            }
            ...
            if (isWindows) {
                ...
                System.out.println("User Microservice Servers are running for Windows!");
            } else {
                ...
                if (exitCode == 0) {
                    System.out.println("MongoDB setup for User Microservice complete!");
                } else {
            ...
            e.printStackTrace();
            System.err.println("Error starting MongoDB servers for the User Microservice.");
        }
    }
}
